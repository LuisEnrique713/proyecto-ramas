...
<?php if(count($data)>0):?>
    <?php foreach($data as $d):?>
          <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form method="POST"  autocomplete="off" action="../../folder/appointment.php?id=<?php echo $d->codcit; ?>"  role="form">
             

              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Inicio</span>
                
                <input type="datetime-local" name="start" value="<?php echo $d->end; ?>"
              ...
              <label class="block text-sm">
                ...
                <input type="datetime-local" name="end" value="<?php echo $d->start; ?>"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
