          ...
          <div class="container px-6 mx-auto grid">
           ...
           <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form method="POST"  autocomplete="off" enctype="multipart/form-data"  role="form">
               ...
               <textarea name="asunto" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" rows="3" placeholder="Enter some long form content."></textarea>
              </label>
              ...
              <label class="block mt-4 text-sm">
                ...
                <select name="color" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
              ...
              <label class="block mt-4 text-sm">
                ...
                <select  name="codpaci" id="paci" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                  <option>Selecione un paciente</option>
              ...
              <label class="block mt-4 text-sm">
                ...
                <select  name="coddoc" id="doc" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
              ...
              <label class="block mt-4 text-sm">
                ...
                <select  name="idhora" id="hora" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
              ...
              <label class="block text-sm">
                ...
                <input type="datetime-local" name="end" value="2021-11-12T19:30"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
...
$sql2 = "INSERT INTO appointment(asunto,color,codpaci,coddoc,idhora,codespe,start,end,estado)VALUES ('$asunto','$color','$codpaci','$coddoc','$idhora','$codespe','$start','$end','$estado')";
