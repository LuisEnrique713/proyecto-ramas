          ...
          <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form method="POST"  autocomplete="off" action="../../folder/patients.php?id=<?php echo $d->codpaci; ?>"  role="form">
              <label class="block text-sm">
                ...
                <input name="dnipa" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="8" value="<?php echo $d->dnipa; ?>" type="text"
              ...
              <label class="block text-sm">
                ...
                <input name="nombrep" value="<?php echo $d->nombrep; ?>" type="text"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="Jane Doe"
                />
              </label>
              ...
              <label class="block text-sm">
                ...
                <input name="apellidop" value="<?php echo $d->apellidop; ?>" type="text"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="Jane Doe"
                />
              </label>
              ...
              <div class="mt-4 text-sm">
                ...
                <input class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" name="seguro" type="radio" id="seguro" value="<?php echo $d->seguro; ?>" <?php echo ($d->seguro== 'Si') ?  "checked" : "" ;  ?>/>
                  ...
                  <input class="text-purple-600 form-radio focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" name="seguro" type="radio" id="seguro" value="<?php echo $d->seguro; ?>" <?php echo ($d->seguro== 'No') ?  "checked" : "" ;  ?>/> 
              ...
              <label class="block text-sm">
                ...
                <input name="tele" maxlength="9" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo $d->tele; ?>" type="text"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="Jane Doe"
                />
              </label>
              ...
              <label class="block text-sm">
                ...
                <input name="email" value="<?php echo $d->email; ?>" type="text"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="Jane Doe"
                />
              </label>
              ...
              <label class="block text-sm">
                ...
                <input name="usuario" value="<?php echo $d->usuario; ?>" type="text"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  placeholder="Jane Doe"
                />
              </label>
