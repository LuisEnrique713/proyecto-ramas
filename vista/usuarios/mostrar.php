          ...
          <div class="container px-6 mx-auto grid">
            ...
            <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                          ...
                          <a href="../vista/usuarios/edit.php?id=<?php echo $va["id"]; ?>" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                            aria-label="Edit">
                            <svg
                              class="w-5 h-5"
                              aria-hidden="true"
                          ...
                          <a href="#" id="eliminar_<?php echo $va["id"]; ?>" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray barra"
                            aria-label="Edit">
                           <svg
                              class="w-5 h-5"
                              aria-hidden="true"
                          ...
                          <a href="../vista/usuarios/password.php?id=<?php echo $va["id"]; ?>" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                            aria-label="Edit">
                            <svg
                              class="w-5 h-5"
                              aria-hidden="true"
